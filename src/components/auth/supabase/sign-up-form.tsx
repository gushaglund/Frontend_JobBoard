    ...
    <Stack spacing={4}>
      <Stack spacing={1}>
        ...
        <Typography color="text.secondary" variant="body2">
          ...
          <Link component={RouterLink} href={paths.auth.supabase.signIn} variant="subtitle2" sx={{ color: '#3278ff' }}>
            Sign in
          </Link>
        </Typography>
      </Stack>
              ...
              render={({ field }) => (
                <div>
                  <FormControlLabel
                    ...
                    label={
                      <React.Fragment>
                        I have read the <Link sx={{ color: '#3278ff' }}>terms and conditions</Link>
                      </React.Fragment>
                    }
                  />
